...
SELECT * FROM orders o 
	WHERE o.ship_state LIKE 'PENNSYLVANIA';
...
SELECT first_name , last_name FROM employees e 
 ...
 SELECT first_name, last_name, phone from customers c 
 	WHERE c.city LIKE 'WASHINGTON' ;
  	
 -- List the first name, last name, and phone number for all customers from the 202 area code ordered by last name, first.
 SELECT first_name, last_name, phone from customers c 
 	WHERE c.city LIKE 'WASHINGTON' 
